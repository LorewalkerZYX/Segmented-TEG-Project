...
# GA Compare with Uni4000, Uni3000, Bias4000
...
if M == 1:
    Mp = 1.757388468984283
    Sp = 1.973350011661692
elif M == 0:
    Mp = 1.405791256436393 
    Sp = 1.956318094348042
# Mp = 1.776
# Sp = 1.9283
'''
...
Sp = 1.973350011661692
'''
Mp0 = 1.405791256436393 
Sp0 = 1.956318094348042
...
if M == 1:
    TEG_NET.load_state_dict(torch.load('NewTEGNetSegQR1\'.pkl'))
else:
